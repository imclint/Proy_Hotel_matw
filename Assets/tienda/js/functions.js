...
if(document.querySelector("#formRegister")){
    ...
    formRegister.onsubmit = function(e) {
		...
		let strPassClient = document.querySelector('#txtPassCliente').value;
		//console.log(strPassClient);
        if(strApellido == '' || strNombre == '' || strEmail == '' || intTelefono == ''||strPassClient=="" )
        {
