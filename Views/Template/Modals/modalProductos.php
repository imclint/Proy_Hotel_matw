...
<div class="modal fade" id="modalFormProductos" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-m-0-md" >
              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control"  id="txtDescripcions" name="txtDescripcions" cols="30" rows="2"></textarea>
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" value="0" id="txtCapacidad" name="txtCapacidad" type="text" required="">
                        </div>
                    </div>
              ...
              <div class="tile-footer">
                 <div class="form-group col-md-12">
                     ...
                     <div id="containerImages">
                         <div id="div24">
                             <div class="prevImage">
                                 <img src="<?= media(); ?>/images/uploads/loading.jpg">
                             </div>
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      <div class="modal-header header-primary">
        <h5 class="modal-title" id="titleModal">Datos de la Habitación</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <table class="table table-bordered">
          <tbody>
            <tr>
              <td></td>
              <td  >
              <input class="form-control" id="celCodigo"  type="hidden">
              </td>
            </tr>
            <tr>
              <td>Nombres:</td>
