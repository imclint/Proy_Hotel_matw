...
<html lang="es">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Passión Barranco</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <!-- <li><a class="dropdown-item" href="<? //echo base_url(); ?>/opciones"><i class="fa fa-cog fa-lg"></i> Settings</a></li> -->
