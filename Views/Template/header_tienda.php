...
<head>
	...
	<?php 
		...
		if(!empty($data['producto'])){
			...
			$urlWeb = base_url()."/tienda/producto/".$data['producto']['idhabitacion']."/".$data['producto']['ruta_categoria'];
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p>1- ¿Si tengo 16 años,puedo realizar una reserva?</p>
			<p>Debe ser mayor de edad(18 años) para poder reservar.</p>  
			<br>
			<p>2- ¿Cuántas habitaciones máximo puedo reservar?</p>
			<p>Pueden reservar varias habitaciones de la misma categoria o cualquie otra categoria mientra no sea la misma habitacion.</p>
			<br>
	        <p>3- He hecho una reserva de hotel ¿Cómo sé si esta confirmada?</p>
			<p>	Una vez realizada la reserva te muestra un mensaje agradeciendo por la Reserva</p>
	      </div>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= base_url(); ?>/tienda">Habitaciones</a>
							</li>
