<?php 
 ...
 ?>
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								...
								<span class="ltext-101 cl2 respon2" style="color: white;text-shadow: 0 0 0.2em #87F, 0 0 0.2em #87F,0 0 0.2em #87F">
							...
							<div class="layer-slick1 animated visible-false" data-appear="fadeInUp" data-delay="800">
								...
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1"  style=" color: #76D7C4;text-shadow: 0 0 0.2em #17202A, 0 0 0.2em #17202A,0 0 0.2em #17202A">
									<?= $arrSlider[$i]['nombre'] ?>
								</h2>
							</div>
	...
	<!-- Banner -->
	<div class="sec-banner bg0 p-t-0 p-b-0">
		<div class="container">
			<div class="row">
				<?php 
