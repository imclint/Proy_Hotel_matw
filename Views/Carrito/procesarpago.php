		...
		<div class="row">
			<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					?>
						<div>
							<label for="tipopago">Elegir Fecha a Reservar <span class="required">*</span></label>
							<div class="bor8 bg0 m-b-22">
								<div id="daterange">
									<input class="form-control" id="txtCiudad" type="text"  name="daterange"   value="" />
								</div>
								
								<!-- <input id="txtCiudad" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" value="" placeholder="Si / No / Tal ves ?"> -->
							</div>

							<label for="tipopago">Recomendaria la pagina de Passión Barranco ? <span class="required">*</span></label>
							
							<div class="bor8 bg0 m-b-12">
								<input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15"  name="state"  placeholder="Si/No/Tal Ves ...">
							</div>
						  	...
						  	<form id="formRegister"> 
						 		...
						 		<div class="row">
								 	...
								 	<div class="col col-md-6 form-group">
										...
										<input type="password" class="form-control valid validContraseña" id="txtPassCliente" name="txtPassCliente" required="">
									</div>
					...
					<div class="flex-w flex-t bor12 p-b-13">
						...
						<div class="size-209">
							<span class="mtext-110 cl2">
								<?php // SMONEY.formatMoney(COSTOENVIO) ?>
							</span>
						</div> -->
					</div>
