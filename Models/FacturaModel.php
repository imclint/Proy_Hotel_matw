	...
	class FacturaModel extends Mysql
	{
		...
		public function selectPedido(int $idpedido, $idpersona = NULL){
			...
			if(!empty($requestPedido)){
				...
				$sql_detalle = "SELECT p.idHabitacion, p.Nombre as producto, d.precio, d.cantidad FROM detalle_pedido d INNER JOIN habitaciones p ON d.productoid = p.idHabitacion WHERE d.pedidoid = $idpedido";
