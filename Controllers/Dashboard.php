<?php 
	...
	class Dashboard extends Controllers{
		...
		{
			$data['page_id'] = 2;
			$data['page_tag'] = "Dashboard - Hotel Passion Barranco ";
			$data['page_title'] = "Dashboard - Hotel Passion Barranco ";
			$data['page_name'] = "dashboard";
			$data['page_functions_js'] = "functions_dashboard.js";
			$data['usuarios'] = $this->model->cantUsuarios();
			$data['clientes'] = $this->model->cantClientes();
			$data['productos'] = $this->model->cantProductos();
			$data['habitacionesDisponibles'] = $this->model->cantHabitacionesDisponibles();
